...
// console.log(media);
	return (
		<Link to={`/details/${media}/${item.id}`} className="relative ">
			<div className={' sm:h-[28rem] h-[25rem] flex-col flex shadow-lg rounded-md w-ful border-red-500 gap-1 overflow-hidden mb-5 hover:scale-[1.01] duration-300 hover:border mt-5'} >
			...
			<div
				...
				className={`absolute top-5 right-0 p-2 rounded-full text-2xl bg-gray-500/50 hover:`}>
